...
public enum TypeMapper {
    ...
    TypeMapper(Class<?> primitiveType, String jdbcSetterMethod, String jdbcGetterMethod, String displayName, JDBCType jdbcType) {
    ...
    public boolean isWrapper() {
        return this == BYTE_WRAPPER ||
                this == SHORT_WRAPPER ||
                this == INTEGER_WRAPPER ||
                this == LONG_WRAPPER ||
                this == FLOAT_WRAPPER ||
                this == DOUBLE_WRAPPER ||
                this == BOOLEAN_WRAPPER ||
                this == CHARACTER_WRAPPER;
    }

    public static boolean isSimple(String type) {
        TypeMapper typeMapper = fromSimpleName(type);
        return typeMapper != null && typeMapper.isSimple();
    }

    public boolean isSimple() {
        return isWrapper() || isPrimitive() || isDateTime() || this == STRING || this == BIG_DECIMAL || this == BIG_INTEGER;
    }
    ...
    /**
     * Find TypeMapper by Class
     */
    public static TypeMapper fromClass(Class<?> clazz) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by simple class name
     */
    public static TypeMapper fromSimpleName(String simpleName) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by JDBC setter method name
     */
    public static TypeMapper fromJdbcSetter(String setterMethod) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by JDBC getter method name
     */
    public static TypeMapper fromJdbcGetter(String getterMethod) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by JDBC type
     */
    public static TypeMapper fromJdbcType(JDBCType jdbcType) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by SQL type constant
     */
    public static TypeMapper fromSqlType(int sqlType) {
        for (TypeMapper type : values()) {
    ...
    /**
     * Find TypeMapper by SQL type name
     */
    public static TypeMapper fromSqlTypeName(String sqlTypeName) {
        for (TypeMapper type : values()) {
     ...
     */
    public static TypeMapper[] getNumericTypes() {
     ...
     */
    public static TypeMapper[] getPrimitiveTypes() {
        return new TypeMapper[]{
